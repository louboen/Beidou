...
# 图片素材 ID（已上传）
DOCTOR_IMAGE_MEDIA_ID = "K03y2eZTmx34znaim3BBR0mcd4ST204qZxqwsn6fxGetw2V3UV1_X4iF73jYTdl7"
QR_CODE_MEDIA_ID = "K03y2eZTmx34znaim3BBR3Z8CPM1CL8LwrW9ryNu4JKGYSYiWf-XsOyfTEFUT0O1"
    ...
    if topic_type == "节气养生":
        ...
        <section style="max-width: 100%; box-sizing: border-box;">
            ...
            <section style="margin-bottom: 20px; line-height: 1.8;">
                ...
                <p style="margin-bottom: 15px;"><strong>食谱一：养生粥</strong></p>
                ...
                <p style="margin-bottom: 15px;"><strong>食谱二：养生茶</strong></p>
                ...
                <p style="margin-bottom: 15px;"><strong>食谱三：养生汤</strong></p>
    ...
    <section style="margin-top: 40px; padding: 20px; background-color: #f5f5f5; border-radius: 10px;">
        ...
        <section style="display: flex; justify-content: center; align-items: flex-start; margin-bottom: 20px;">
            <section style="flex: 0 0 150px; margin-right: 20px;">
                <img src="{DOCTOR_IMAGE_MEDIA_ID}" style="width: 150px; height: 200px; object-fit: cover; border-radius: 10px;" alt="娄伯恩医生"/>
            </section>
        ...
        <section style="text-align: center; margin-bottom: 20px;">
            <img src="{QR_CODE_MEDIA_ID}" style="width: 150px; height: 150px;" alt="微信二维码"/>
...
def create_draft(access_token, title, content):
    ...
    data = {
        "articles": [
            {
                "title": title[:64],  # 标题限制 64 字符
                "author": "娄医",  # 作者限制 8 字符
                "digest": f"中医健康科普 - {title[:30]}",  # 摘要限制 120 字符
                "content": full_content,
                "thumb_media_id": DOCTOR_IMAGE_MEDIA_ID,  # 使用医生照片作为封面
                "show_cover_pic": 1
            }
        ]
    }
...
def main():
    ...
    # 4. 创建草稿
    print("\n📤 发布到微信公众号草稿箱...")
    result = create_draft(access_token, topic_info['title'], content)
