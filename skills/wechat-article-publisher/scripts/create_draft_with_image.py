...
def create_draft_with_image(access_token, thumb_media_id):
    """使用图片封面创建草稿"""
    print("创建带封面的草稿...")
    ...
    article = {
        "title": "中医养生：春季养肝正当时",
        "author": "中医娄伯恩",
        "digest": "春季是万物复苏的季节，也是养肝护肝的最佳时机。中医认为，春季对应肝脏，肝主疏泄，喜条达而恶抑郁。",
        "content": """
            <h1>中医养生：春季养肝正当时</h1>
            ...
            <ul>
                ...
                <li><strong>睡前泡脚</strong>：用温水泡脚15分钟，有助睡眠</li>
            ...
            <p style="color: #666; font-size: 14px;">
                ...
                <strong>发布工具</strong>：OpenClaw AI助手 + 微信公众号发布技能<br>
                <strong>文章类型</strong>：中医养生科普
            </p>
            
            <p style="color: #999; font-size: 12px; margin-top: 20px;">
                注意：本文仅供参考，如有不适请及时就医。养生贵在坚持，持之以恒方能见效。
            </p>
        """,
        "content_source_url": "",
...
def main():
    ...
    # 创建带封面的草稿
    print("\n3. 创建带封面的草稿...")
    media_id = create_draft_with_image(access_token, PERMANENT_IMAGE_MEDIA_ID)
