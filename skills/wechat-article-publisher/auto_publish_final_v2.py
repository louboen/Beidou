...
TOPIC_LIBRARY = {
    ...
    "中医食疗": [
        {"title": "春季养肝食谱：3 道家常菜", "focus": "春季养肝，多吃绿色蔬菜"},
    ...
    if topic_type == "节气养生":
        ...
        <section style="max-width: 100%; box-sizing: border-box;">
            ...
            <section style="margin-bottom: 20px; line-height: 1.8;">
                ...
                <p style="margin-bottom: 15px;">{focus}。中医认为，顺应四时变化养生，可以达到事半功倍的效果。此时人体阳气逐渐升发，肝气旺盛，脾胃功能相对较弱，容易出现湿气困脾的情况。</p>
                
                <p style="margin-bottom: 15px;"><strong>🌿 养生原则</strong></p>
                <p style="margin-bottom: 15px;">1. <strong>起居调养</strong>：早睡早起，保持充足睡眠。建议晚上 11 点前入睡，早上 6-7 点起床，顺应自然界阳气升发的规律。</p>
                <p style="margin-bottom: 15px;">2. <strong>饮食调理</strong>：清淡饮食，多吃时令蔬菜。推荐食用山药、薏米、赤小豆等健脾祛湿的食材，少吃生冷、油腻食物。</p>
                <p style="margin-bottom: 15px;">3. <strong>运动保健</strong>：适度运动，如散步、太极拳、八段锦等。运动可以促进气血运行，帮助排出体内湿气，但不宜过度出汗。</p>
                <p style="margin-bottom: 15px;">4. <strong>情志调节</strong>：保持心情舒畅，避免情绪波动。中医认为"怒伤肝"，情绪不稳定会影响肝的疏泄功能。</p>
        ...
        <section style="max-width: 100%; box-sizing: border-box;">
            ...
            <section style="margin-bottom: 20px; line-height: 1.8;">
                ...
                <p style="margin-bottom: 15px;">{focus}。中医食疗讲究"药食同源"，通过日常饮食调理身体，安全有效。食物具有四气五味，合理搭配可以达到预防疾病、强身健体的目的。</p>
                
                <p style="margin-bottom: 15px;"><strong>📋 推荐食谱</strong></p>
                
                <p style="margin-bottom: 15px;"><strong>食谱一：山药莲子粥</strong></p>
                <p style="margin-bottom: 15px;">材料：山药 30g、莲子 15g、小米 50g、红枣 3 枚</p>
                <p style="margin-bottom: 15px;">做法：山药去皮切块，莲子去心，小米洗净，红枣去核。所有材料放入锅中，加水适量，大火煮沸后转小火煮 30 分钟即可。</p>
                <p style="margin-bottom: 15px;">功效：健脾养胃，安神助眠。适合脾胃虚弱、食欲不振、失眠多梦者食用。</p>
                
                <p style="margin-bottom: 15px;"><strong>食谱二：菊花枸杞茶</strong></p>
                <p style="margin-bottom: 15px;">材料：菊花 5g、枸杞 10g、红枣 3 枚、冰糖适量</p>
                <p style="margin-bottom: 15px;">做法：菊花、枸杞、红枣洗净，放入茶壶中，沸水冲泡，加盖焖 10 分钟，加入冰糖调味即可。</p>
                <p style="margin-bottom: 15px;">功效：清肝明目，养血安神。适合用眼过度、眼睛干涩、肝火旺盛者饮用。</p>
                
                <p style="margin-bottom: 15px;"><strong>食谱三：百合银耳汤</strong></p>
                <p style="margin-bottom: 15px;">材料：百合 20g、银耳 10g、冰糖适量</p>
                <p style="margin-bottom: 15px;">做法：银耳泡发撕小朵，百合洗净。所有材料放入锅中，加水适量，大火煮沸后转小火炖 1 小时，加入冰糖调味。</p>
                <p style="margin-bottom: 15px;">功效：滋阴润肺，美容养颜。适合皮肤干燥、咳嗽少痰、阴虚火旺者食用。</p>
                ...
                <p style="margin-bottom: 15px;">• 食疗不能替代药物治疗，如有疾病请及时就医</p>
            </section>
        </section>
        """
    else:  # 穴位保健
        ...
        <section style="max-width: 100%; box-sizing: border-box;">
            ...
            <section style="margin-bottom: 20px; line-height: 1.8;">
                ...
                <p style="margin-bottom: 15px;">{focus}。穴位按摩是中医传统保健方法，简单易学，安全有效。通过刺激特定穴位，可以疏通经络、调和气血，达到防病治病的目的。</p>
                
                <p style="margin-bottom: 15px;"><strong>🔍 穴位定位</strong></p>
                <p style="margin-bottom: 15px;">内关穴位于前臂掌侧，腕横纹上 2 寸（约三横指），掌长肌腱与桡侧腕屈肌腱之间。取穴时，手掌向上，从腕横纹向上量三横指，在两筋之间即是。</p>
                
                <p style="margin-bottom: 15px;"><strong>👆 按摩方法</strong></p>
                <p style="margin-bottom: 15px;">1. <strong>指按法</strong>：用拇指指腹按压穴位，其余四指托住前臂</p>
                <p style="margin-bottom: 15px;">2. <strong>力度</strong>：以感觉酸胀为度，不可用力过猛，以免损伤组织</p>
                <p style="margin-bottom: 15px;">3. <strong>时间</strong>：每次按压 3-5 分钟，每日 2-3 次，早晚各一次为宜</p>
                <p style="margin-bottom: 15px;">4. <strong>呼吸</strong>：按压时缓慢深呼吸，放松身心，效果更佳</p>
                <p style="margin-bottom: 15px;">5. <strong>配穴</strong>：可配合神门穴、心俞穴等，增强安神效果</p>
                
                <p style="margin-bottom: 15px;"><strong>💡 保健功效</strong></p>
                <p style="margin-bottom: 15px;">• <strong>宁心安神</strong>：缓解心悸、胸闷、失眠等症状</p>
                <p style="margin-bottom: 15px;">• <strong>和胃降逆</strong>：改善恶心、呕吐、胃痛等胃部不适</p>
                <p style="margin-bottom: 15px;">• <strong>疏通经络</strong>：缓解上肢疼痛、麻木等症状</p>
                <p style="margin-bottom: 15px;">• <strong>预防保健</strong>：日常按摩可强身健体，预防心血管疾病</p>
                
                <p style="margin-bottom: 15px;"><strong>⚠️ 注意事项</strong></p>
                <p style="margin-bottom: 15px;">• 饭后 1 小时内不宜按摩，以免影响消化</p>
                <p style="margin-bottom: 15px;">• 孕妇慎用，某些穴位可能引起子宫收缩</p>
                <p style="margin-bottom: 15px;">• 皮肤破损、感染处禁止按摩</p>
                <p style="margin-bottom: 15px;">• 如有严重不适，立即停止并就医</p>
            </section>
        </section>
        """
