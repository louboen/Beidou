...
def generate_and_upload_cover(title, subtitle, color, access_token):
    ...
    # 步骤 2：启动 HTTP 服务器
    print("🌐 启动 HTTP 服务器...")
    server_proc = subprocess.Popen(['python3', '-m', 'http.server', '8898'], cwd=ASSETS_DIR, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    time.sleep(2)
    ...
    try:
        # 步骤 3：打开页面
        print("📖 打开页面...")
        cmd1 = f"openclaw browser open --url 'http://localhost:8898/{html_filename}' --target host"
...
def get_sipiwei_content():
    ...
    <section style="max-width: 100%; box-sizing: border-box;">
        ...
        <section style="margin-bottom: 20px; line-height: 1.8;">
            ...
            <p style="margin-bottom: 15px;">中医认为"脾胃为后天之本"，脾胃功能好坏直接影响消化吸收和气血生化。脾主运化，胃主受纳，两者共同完成食物的消化吸收，将营养物质输送到全身。现代人饮食不规律、工作压力大、熬夜多，很容易出现脾胃虚弱的情况，表现为食欲不振、疲倦乏力、大便溏稀等症状。长期脾胃虚弱还会影响免疫力，导致容易感冒、体质下降。</p>
            ...
            <p style="margin-bottom: 15px;">做法：所有材料洗净，放入茶壶中，沸水冲泡，加盖焖 15 分钟即可。代茶饮用。</p>
            <p style="margin-bottom: 15px;">功效：健脾益气，祛湿化痰。适合脾虚湿重、腹胀便溏者饮用。</p>
            <p style="margin-bottom: 15px;"><strong>⚠️ 饮食注意</strong></p>
            <p style="margin-bottom: 15px;">• 少吃生冷、油腻、辛辣刺激食物</p>
            <p style="margin-bottom: 15px;">• 规律饮食，细嚼慢咽，七分饱为宜</p>
            <p style="margin-bottom: 15px;">• 保持心情舒畅，避免思虑过度</p>
        </section>
    </section>
    """
...
def get_yanggan_content():
    ...
    <section style="max-width: 100%; box-sizing: border-box;">
        ...
        <section style="margin-bottom: 20px; line-height: 1.8;">
            ...
            <p style="margin-bottom: 15px;">• 玫瑰山楂茶：疏肝理气</p>
        </section>
    </section>
    """
...
def get_zusanli_content():
    ...
    <section style="max-width: 100%; box-sizing: border-box;">
        ...
        <section style="margin-bottom: 20px; line-height: 1.8;">
            <p style="margin-bottom: 15px;"><strong>📍 穴位定位</strong></p>
            <p style="margin-bottom: 15px;">足三里位于小腿外侧，犊鼻穴下 3 寸（约四横指），胫骨前嵴外一横指处。</p>
            <p style="margin-bottom: 15px;"><strong>👆 按摩方法</strong></p>
            <p style="margin-bottom: 15px;">用拇指按压 3-5 分钟</p>
            <p style="margin-bottom: 15px;"><strong>💡 功效</strong></p>
            <p style="margin-bottom: 15px;">健脾和胃，增强免疫力</p>
        </section>
    </section>
    """
...
def get_taichong_content():
    ...
    <section style="max-width: 100%; box-sizing: border-box;">
        ...
        <section style="margin-bottom: 20px; line-height: 1.8;">
            <p style="margin-bottom: 15px;"><strong>📍 穴位定位</strong></p>
            <p style="margin-bottom: 15px;">太冲穴位于足背侧，第 1、2 跖骨结合部之前的凹陷处。</p>
            <p style="margin-bottom: 15px;"><strong>👆 按摩方法</strong></p>
            <p style="margin-bottom: 15px;">用拇指按压 3-5 分钟</p>
            <p style="margin-bottom: 15px;"><strong>💡 功效</strong></p>
...
def main():
    ...
    if not cover_media_id:
        ...
        print(f"\n✅ 封面已上传到素材库，MediaID: {cover_media_id[:50]}...")
    ...
    # 6. 创建草稿（使用已上传的封面）
    print("\n📤 【步骤 4】发布到微信公众号草稿箱...")
    print(f"   使用封面 MediaID: {cover_media_id[:50]}...")
